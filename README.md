# soft_hand_klampt (ROS package)

This repository contains the model of the Pisa/IIT to be used for simulations with Klampt.

The Pisa/IIT hand is a robotic hand as described in:
